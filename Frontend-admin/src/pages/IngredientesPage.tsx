          ...
          <table className="w-full text-left">
            <thead className="bg-surface-container-high">
              <tr>
                ...
                <th className="px-6 py-4 font-body font-semibold text-sm text-primary uppercase tracking-wider">Alérgeno</th>
                ...
                <tr key={item.id} className="hover:bg-surface-container-high/50 transition-colors">
                  ...
                  <td className="px-6 py-4">
                    <div className="flex items-center gap-2">
                      ...
                      <button
                        onClick={() => { if (confirm('¿Eliminar este ingrediente?')) deleteMutation.mutate(item.id); }}
